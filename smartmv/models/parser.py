import ast
from smartmv.models.conditions.condition import Condition

from smartmv.models.conditions import ConjunctionCondition, ContainsCondition, ExtensionCondition
...
class RuleParser(ast.NodeVisitor):
    ...
    def visit_Name(self, node: ast.Name) -> callable:
