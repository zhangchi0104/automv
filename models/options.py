...
class Options(object):
    ...
    def __init__(self, options: dict):
        ...
        self._sub_dir: str = options['createSubDir']
    ...
    def create_sub_dir(self, destination: Path, file_name: str) -> Path: 
        ...
        """
        if self._sub_dir == None or self._sub_dir.isspace():
            return
        if self._sub_dir[0] == '%' and self._sub_dir[-1] == '%':
            pattern = re.compile(self._sub_dir[1:-1])
    ...
    @property
    def should_create_sub_dir(self):
